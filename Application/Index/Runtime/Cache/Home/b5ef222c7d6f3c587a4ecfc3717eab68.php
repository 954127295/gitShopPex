...
<html lang="zh-CN">
  ...
  <body>
	...
	<div id="hr"></div><br>
	<div class="logingo"><a href="<?php echo U('User/login');?>">立即登录</a></div>
	<div class="s_r_div">&nbsp;注册即有好礼相送</div>
	<div class="r_content_div">
	<form onsubmit="return checkform()" action="<?php echo U('User/remail');?>" method="post">
		<div id="r_content_div_t">
			&nbsp;&nbsp;&nbsp;&nbsp;<a>*</a>&nbsp;会员名&nbsp;&nbsp;&nbsp;<input id="input" name="username" type="text" />
			<br>
			<a id="ua" style="display:none;">*请填写6-12位的用户名</a>
		</div>
		<div id="r_content_div_t">
			&nbsp;&nbsp;&nbsp;&nbsp;<a>*</a>&nbsp;&nbsp;密&nbsp;&nbsp;码&nbsp;&nbsp;&nbsp;<input id="input" name="password" type="password" />
			<br>
			<a id="pa" style="display:none">*请填写6-12位的密码</a>
		</div>
		<div id="r_content_div_t">
