...
<html lang="zh-CN">
  ...
  <body>
	...
	<div id="hr"></div><br>
	<div class="s_r_div">&nbsp;找回密码，请填写邮箱进行验证</div>
	<div class="r_content_div">
	<form onsubmit="return checkemail()" action="<?php echo U('User/forgetPass');?>" method="post">
		<div id="r_content_div_t">
			<a>*</a>&nbsp;邮箱&nbsp;&nbsp;&nbsp;<input id="input" type="text" name="email" value="" />
			<br>
