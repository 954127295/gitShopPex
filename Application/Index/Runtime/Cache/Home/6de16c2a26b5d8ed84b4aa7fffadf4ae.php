  ...
  <body>
	...
	*{font-family:"微软雅黑";}
	...
	<div class="uc_index_right_div">
		<div id="right_center">
			<a href="<?php echo U('UserCenter/referOrder');?>">提交工单</a>
			<hr>
			...
			<table>
				...
				<?php if(is_array($list)): foreach($list as $key=>$li): ?><tr>
					...
					<tr>
						<td><?php echo ($li['id']+1000); ?></td>
						<td><?php echo ($li["content"]["question"]); ?></td>
						<td><?php echo ($li["ltime"]); ?></td>
						<td><?php if($li["status"] == 'ing'): ?>进行中<?php else: ?>已结束<?php endif; ?></td>
						<td><a href="<?php echo U('UserCenter/showContent',array('id'=>$li['id']));?>">查看</a></td>
					...
					<tr>
						<td colspan="5"><div class="pages"><?php echo ($pages); ?></div></td>
					</tr>
			</table>
			</div>
		</div>
