...
<html lang="zh-CN">
  ...
  <body>
	...
	<div id="hr"></div><br>
	<div class="s_r_div">&nbsp;重置密码</div>
	<div class="r_content_div">
	<form onsubmit="return checkepass()" action="<?php echo U('User/resetPass');?>" method="post">
		<div id="r_content_div_t">
			<a>*</a>&nbsp;新&nbsp;密&nbsp;码&nbsp;&nbsp;&nbsp;&nbsp;<input id="input" type="password" name="password" value="" />
			<br>
			<a id="ec" style="display:none">*请填写正确的6-12位密码</a>
		</div>
		<div id="r_content_div_t">
			<a>*</a>&nbsp;确认密码&nbsp;&nbsp;&nbsp;<input id="input" type="password" name="cpassword" value="" />
			<br>
			<a id="ecs" style="display:none">*两次密码不一致</a>
		</div>
		<div id="r_content_div_t">
